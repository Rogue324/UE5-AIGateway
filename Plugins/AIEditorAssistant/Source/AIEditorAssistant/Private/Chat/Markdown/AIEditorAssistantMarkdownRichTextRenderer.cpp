...
namespace
{
    const FName ChatRichTextStyleSetName(TEXT("AIEditorAssistantChatRichText"));
...
FString FAIEditorAssistantMarkdownRichTextRenderer::NormalizeForDisplay(const FString& Text)
{
    FString Output;
...
const ISlateStyle& FAIEditorAssistantMarkdownRichTextRenderer::GetStyle()
{
...
FString FAIEditorAssistantMarkdownRichTextRenderer::RenderMarkdownToRichText(const FString& MarkdownText, bool bTreatAsParagraph)
{
    ...
    FAIEditorAssistantMarkdownParser::NormalizeLineEndings(NormalizedMarkdown).ParseIntoArray(Lines, TEXT("\n"), false);
...
FString FAIEditorAssistantMarkdownRichTextRenderer::RenderInlineMarkdown(const FString& Text, bool bEnableStyleTags)
{
...
bool FAIEditorAssistantMarkdownRichTextRenderer::TryExtractHeadingContent(const FString& MarkdownText, FString& OutHeadingContent)
{
...
FString FAIEditorAssistantMarkdownRichTextRenderer::EscapeRichText(const FString& Text)
{
